  ...
  return (
    ...
    <div className="relative">
        <div className="grid grid-cols-1 lg:grid-cols-2">
            <div id="signUp" className="w-full pt-32 relative bg-cover bg-no-repeat">
            ...
            <div id="signIn" className="w-full pt-32 relative bg-cover bg-no-repeat">
                ...
                <div className="flex justify-center p-3">
                    <div className="form-control w-full max-w-xs">
                        ...
                        <button className="btn btn-accent mt-5 text-white" onClick={() => signInwithGoogle()}>Continue with Google</button>
                        <button className="btn mt-5 btn-accent text-white" onClick={() => signInwithGithub()}>Continue with Github</button>
                    </div>
                </div>
            </div>
        </div>
