...
const Login = () => {
  ...
  return (
    <>
      <Helmet>
        <script
          src="https://kit.fontawesome.com/66da2a232b.js"
      ...
      <div className="relative">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div
            id="signUp"
            className="w-full pt-32 relative bg-cover bg-no-repeat"
          >
            <h1 className="text-secondary text-4xl font-bold flex justify-center poppins">
                Sign Up
            </h1>
            <div className="flex justify-center p-3">
              <div className="form-control w-full max-w-xs">
                ...
                <input
                  ...
                  className={
                    "input input-bordered border-2 w-full max-w-xs" +
                    (passwordGood ? "" : " border-red-500")
                  }
                ...
                {passwordGood ? (
                  ...
                  <div className="label text-red-400">
                    You need to have special characters in your password!!
                  </div>
                )}
          ...
          >
            ...
            <div className="flex justify-center p-3">
              <div className="form-control w-full max-w-xs">
                ...
                <button
                  className="btn mt-5 btn-accent text-white"
